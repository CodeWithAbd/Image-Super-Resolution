...
sys.path.append('./')
sys.path.append('../')
from transformers import TPSSpatialTransformer
from station import STNHead
from transformers import FeatureEnhancer, ReasoningTransformer, FeatureEnhancerW2V
from transformers import Transformer as Transformer_V2
from transformers import InfoTransformer
