...
def _demo():
    ...
    features, labels = input.setup_inputs(sess, filenames)

    # Create and initialize model
    [gene_minput, gene_moutput,
     gene_output, gene_var_list,
     disc_real_output, disc_fake_output, disc_var_list] = \
            model.create_model(sess, features, labels)
...
def _train():
    ...
    gene_loss = model.create_generator_loss(disc_fake_output, gene_output, train_features)
